Contributing to papara Core
============================

The papara Core project operates an open contributor model where anyone is
...
The following applies to code changes to the papara Core project, and is not to be
confused with overall papara Network Protocol consensus changes.

Whether a pull request is merged into papara Core rests with the project merge
...
Patches that change papara consensus rules are considerably more involved than
...
Where a patch set proposes to change the papara consensus, it must have been
...
The project leader is the release manager for each papara Core release.
