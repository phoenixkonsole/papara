Contributing to Parara Core
============================

The Parara Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Parara Core project, and is not to be
confused with overall Parara Network Protocol consensus changes.

Whether a pull request is merged into Parara Core rests with the project merge
...
Patches that change Parara consensus rules are considerably more involved than
...
Where a patch set proposes to change the Parara consensus, it must have been
...
The project leader is the release manager for each Parara Core release.
