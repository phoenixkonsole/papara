...
In order to support loading of multiple wallets in Parara-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Parara.cpp.
...
Changes to Parara.cpp
----------------------
Parara.cpp is the entry point into Parara-qt, and as such, will require some minor modifications to provide hooks for
