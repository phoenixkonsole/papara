...
In order to support loading of multiple wallets in papara-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is papara.cpp.
...
Changes to papara.cpp
----------------------
papara.cpp is the entry point into papara-qt, and as such, will require some minor modifications to provide hooks for
