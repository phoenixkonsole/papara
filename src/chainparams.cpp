...
// Copyright (c) 2017-2021 The Parara developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8051;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Parara starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Parara: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // Parara: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // Parara: 60 Seconds
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Parara new blockchain is here";
	...
	//vSeeds.push_back(CDNSSeedData("Parara.cloud", "dnsseed1.Parara.cloud"));
	//vSeeds.push_back(CDNSSeedData("Parara.cloud", "dnsseed2.Parara.cloud"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Parara: 1 day
        nTargetSpacing = 1 * 60;  // Parara: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // nZerocoinStartTime = 1524711188;
        ...
        vSeeds.clear();
     	...
     	vSeeds.push_back(CDNSSeedData("paracoin.org", "dnsseed1.paracoin.org"));
     	vSeeds.push_back(CDNSSeedData("88.198.37.154", "88.198.37.154"));
		vSeeds.push_back(CDNSSeedData("paracoin.org", "dnsseed2.paracoin.org"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Parara addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Parara script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Parara BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Parara BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Parara BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Parara: 1 day
        nTargetSpacing = 1 * 60;        // Parara: 1 minutes
