...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the Parara and zTELOS money supply statistics") + " " + _("on startup"));
...
//    strUsage += HelpMessageOpt("-preferredDenom=<n>", strprintf(_("Preferred Denomination for automatically minted Zerocoin  (1/5/10/50/100/500/1000/5000), 0 for no preference. default: %u)"), 0));
    strUsage += HelpMessageOpt("-backupzParara=<n>", strprintf(_("Enable automatic wallet backups triggered after each zTELOS minting (0-1, default: %u)"), 1));
