...
#ifndef PIVX_CORE_NEW_GUI_paraGUI_H
...
*/
class paraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit paraGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~paraGUI();
...
#endif //PIVX_CORE_NEW_GUI_paraGUI_H
