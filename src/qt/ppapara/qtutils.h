...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, paraGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, paraGUI *gui, double posX = 3);
