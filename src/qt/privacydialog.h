...
public:
    ...
    void setZparaControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzpara_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzpara_clicked();
    void on_pushButtonZparaControl_clicked();
