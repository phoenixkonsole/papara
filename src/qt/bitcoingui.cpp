...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a papara address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and papara: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About papara Core"), this);
    aboutAction->setStatusTip(tr("Show information about papara Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your papara addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified papara addresses"));
    ...
    openAction->setStatusTip(tr("Open a papara: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the papara Core help message to get a list with possible PIVX command-line options"));
